...
public class SharedPreferenceUtil {
    ...
    public boolean getRemPassWd() {
        return mPrefs.getBoolean(REMEMBER_PASSWORD, false);
    }

    public void setRemPassWd(boolean state) {
        mPrefs.edit().putBoolean(REMEMBER_PASSWORD, state).apply();
    }
