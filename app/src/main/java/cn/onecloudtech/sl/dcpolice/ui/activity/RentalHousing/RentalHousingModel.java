 ...
 */
public class RentalHousingModel  implements RentalHousingContract.Model {
    @Override
    public Observable<UploadResult> uploadRentalHosuingInfo(Map<String, RequestBody> map) {
        return Api.getInstance().service
                .uploadRentalHousing(map)
